...
call <sid>hi('CocSemClass', s:cdBlueGreen, {}, 'none', {})
call <sid>hi('CocSemType', s:cdBlueGreen, {}, 'none', {})

" rainbow parentheses
let g:rainbow_conf = {}
let g:rainbow_conf['guifgs'] = [s:cdYellowOrange['gui'], s:cdPink['gui'], s:cdBlue['gui']]
let g:rainbow_conf['ctermfgs'] = [s:cdYellowOrange['cterm'], s:cdPink['cterm'], s:cdBlue['cterm']]
let g:rainbow_conf['operators'] = ''
let g:rainbow_conf['separately'] = { 'cmake': 0, 'text': 0 }
